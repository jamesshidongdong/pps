...
namespace AlwaysPPS.Web.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<ISpRPTByTeamTimeSheetServer, PRPTByTeamTimeSheetServer>(new PerRequestLifetimeManager());
            container.RegisterType<ISpRPTGetTimeSheetByTeamServer, SpRPTGetTimeSheetByTeamServer>(new PerRequestLifetimeManager());
            container.RegisterType<IReportCharDataService, ReportCharDataService>(new PerRequestLifetimeManager());
            container.RegisterType<IReportDataByClient, ReportDataByClients>(new PerRequestLifetimeManager());
            container.RegisterType<IReportDataByDept, ReportDataByDepts>(new PerRequestLifetimeManager());
            container.RegisterType<IReportDataByProject, ReportDataByProjects>(new PerRequestLifetimeManager());
            //todo: add repository
            ...
            container.RegisterType<IRepository<SpRPTByTeamTimeSheet>, Repository<SpRPTByTeamTimeSheet>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
            container.RegisterType<IRepository<SpRPTGetTimeSheetByTeam>, Repository<SpRPTGetTimeSheetByTeam>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
            container.RegisterType<IRepository<ReportCharData>, Repository<ReportCharData>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
            container.RegisterType<IRepository<ReportDataByClient>, Repository<ReportDataByClient>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
            container.RegisterType<IRepository<ReportDateByProject>, Repository<ReportDateByProject>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
            container.RegisterType<IRepository<ReportDataByDept>, Repository<ReportDataByDept>>(new PerRequestLifetimeManager(), new InjectionConstructor(new ResolvedParameter<IDataContext>(AlwaysPPSContext)));
